 ...
 *
 * @param <I> Typ des ID-Attributs
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class SingleIdEntity<I> {
    ...
    public boolean equals(Object obj) {
        ...
        @SuppressWarnings("unchecked") final SingleIdEntity<I> other = (SingleIdEntity<I>) obj;
     ...
     *
     * @param idOnly <code>true</code>, wenn nur ID-Attribute berücksichtigt werden sollen
     * @return String-Repräsentation des Objektes
     */
    public String toString(boolean idOnly) {

        SortedMap<String, PropertyMeta> propertyMap = CLASS_PROPERTY_MAP.computeIfAbsent(getClass(), SingleIdEntity::createPropertyMap);
